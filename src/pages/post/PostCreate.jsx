...
function PostCreate() {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            {/* Success Toast */}
            {showSuccess && (
                <div className="fixed top-4 right-4 z-50 flex items-center gap-2 px-5 py-3 bg-emerald-500/20 border border-emerald-500/30 rounded-xl text-emerald-300  shadow-lg animate-fade-in">
            ...
            <div className="relative z-10 p-4 md:p-8 max-w-3xl mx-auto">
                ...
                <div className=" bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 md:p-8">
                        <h1 className="text-2xl font-bold text-slate-900 mb-6">Yeni Gönderi Oluştur</h1>
